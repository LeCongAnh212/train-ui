<template>
  <div class="relative flex flex-col gap-10">
    ...
    <div class="xs:ps-10 xl:px-28 2xl:px-36">
      <strong class="text-3xl">More from Kitani Studio</strong>
      <p class="my-2">We know the best thins of you. Top pisks for you.</p>
      <div class="no-scrollbar gap-5 xs:flex xs:flex-nowrap xs:overflow-scroll md:grid md:grid-cols-3 lg:grid-cols-4">
        <video-component class="" v-for="video in listVideo" :key="video.id" :video="video" />
      </div>
    </div>

    <div class="xs:ps-10 xl:px-28 2xl:px-36">
      <strong class="text-3xl">Trending Course</strong>
      <p class="my-2">We know the best thins of you. Top pisks for you.</p>
      <div class="no-scrollbar gap-5 xs:flex xs:flex-nowrap xs:overflow-scroll md:grid md:grid-cols-3 lg:grid-cols-4">
        <video-component v-for="video in listTrending" :key="video.id" :video="video" />
      </div>
    </div>

    <div class="xs:ps-10 xl:px-28 2xl:px-36">
      <strong class="text-3xl">Popular Instructor</strong>
      <p class="my-2 max-md:hidden">
        We know the best thins of you. Top pisks for you.
      </p>
      <div class="no-scrollbar w-full xs:overflow-x-scroll">
        <div class="mt-8 flex flex-nowrap gap-5">
          <card-component v-for="instructor in instructors" :key="instructor" :instructor="instructor" />
        </div>
      </div>
    </div>
    <promo-component />
...
import TabsMenuComponent from "@/components/TabsMenuComponent.vue";
    ...
    return {
      listVideo: [
        ...
        },
        {
          id: 11,
          image:
            "https://s3-alpha-sig.figma.com/img/8bb6/ad24/279a44450b38c3fb0c8168706af3c700?Expires=1716163200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=aUvca63lxNue0uEjNX~EhBgLCTloOjew1wPRPmEDrUUkj43YUSrm4Gk3rCqII3PSJjT-UnC22--rQDER4cyunTkTtcelsCADY~C8UBlDs-wvZsqQlGvWJm~fr576nQeUp9ID9QfSIstv6n6lEWYBivAyN~Nmlbr4mVJSQpUflbHcLvQbIYyU0zTshFarHu6kRKCbojb9pndyyc8plc9ecgTeBnlzfmT9dMJ5nOv3EHxELSSRZJNMGhbXG1oIrvaHIByUYmIxOJ-U8Zx1vXwIEycam0FCyfanpEVbj~wC-NS6XIjO9g0ptL8TFRAxE2HKQ5SsCLSC1zUu~cY0kcHFQw__",
      ...
      listTrending: [
        ...
        },
        {
          id: 3,
          image:
            "https://s3-alpha-sig.figma.com/img/3232/9f7e/5ff984311a578929f83ddcf74a23bc31?Expires=1716163200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=jYpv8~wHP~kyQ4ZmBTech4~tM5OwbzL201oCwz8xeAV3OT4lLlgphwDty5SeQ3REyRerAQtTjvsyzx-FgTT~CIOx4cVvUV0rjj~8Flm~a1OZlYApO~8S1IRK-YW-Y8DUqCIqW9vh9nUrQwcDZqMhQ8VkIV-Pm~-zvYBkUkywaukTjQn0lH6GqZV7xoiLx25fEBRwMm~ocfi4fXsnwwmeLkaF8FYRRCFsHdo3vll2dBgzbrX2~feS1n8QUiavKU-ci-vtBZ6tR-iKvWqY~ZzVgIN64wMMvFdlYXP7a2Kzzb1cLiHfRgdMBag3HmA0Y85D-7F73VM9QFUyAVb2YgkSPg__",
        ...
        },
        {
          id: 7,
          image:
            "https://s3-alpha-sig.figma.com/img/328e/56d5/e52d70944073635318e44d132473e832?Expires=1716163200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=b90qDmXf~KSgqnZhXrk9LLRJjYJK1Q6tz~LTuB9luy5OSNOhJsj4pM3rbk6BMf6N-M-ZlFNbrbteoiZmNaGSJP-zU40~g6GclBP0HqGW9Y8uKkKq7IRmMeKNCxQ7NcrJNPhjPaYfN7zc1-B3MTydetMDJq-KygALfYOg3VPIG29eFUV04IspjKx8CqSupmq2PGe3VaOMvkfUCj5NjFiWQ7S~DGQBomRVfslhtxKzXD2JVrin2SD9lXlCBzcOVGwQ~~WJWuyFyAA1gRhGgRNalbcr~BaH5Agz~neET~68Invt~gYzBvMXIVHEyeMOElRuvg8SddcXoQ2P9AL-Y7ubMg__",
          title: "Ionic - Build iOS, Android & Web...",
          description:
            "More than 8yr Experience as Illustrator. Learn how to becoming professional Illustrator Now...",
          rate: 4.9,
        ...
        },
        {
          id: 8,
          image:
            "https://s3-alpha-sig.figma.com/img/e149/24aa/12827a29123663bc5d0c7e37562ecb36?Expires=1716163200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=Re4iP~g6-uAR9AEjMR1CV2lVn5z1vLS1akndezaheLlbN~AIHrjfovN6oWJfb2SRcoV5S3v2eaE~CqT4Y73caBhNR4l-mjRco7G03wZX0gyQHpcOP~qMLJX-ZDgwJq4r5nymEk8Gq8Rfpp3EcxHYLZyNjygm6RzMkrXcUal7u18ERuwLVP0kIWOd5fa3jrvcu6PUel~NMXEZoOxD70SJrFInWwonNpuXER-3k3FGRB3UkGb1xcRVD0ZzxszvnfWYd3wSSkq6TiS28RFCoV72Pyq~UMZ9DqtGSxnN8ygpztkOVHiGVNiPUcpjHeQ2h~~KFsgjBfwtbRjq26ByFgrYWw__",
          title: "Ionic - Build iOS, Android & Web...",
          description:
            "More than 8yr Experience as Illustrator. Learn how to becoming professional Illustrator Now...",
          rate: 4.9,
